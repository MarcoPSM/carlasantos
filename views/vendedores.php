...
$this->activeMenu = 'vendedores';


?>
<h1>Porque é fantástico vender com a Carla</h1>

<br>
<div id="vendedores-content">
    ...
    <div class="row">
        ...
        <ul>
            <li>Determinar o valor de mercado justo para o seu imóvel, recorrendo a uma análise comparativa de mercado.</li>
            <li>Estudar e recomendar potenciais melhorias que maximizem o valor do imóvel.</li>
        </ul>
        <p class="text-justify fw-bold">Marketing:</p>
        <ul>
